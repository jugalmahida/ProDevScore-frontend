...
// You might need useRouter if you redirect on success
...
function RegisterForm() {
  ...
  const { register, verifyCode, loading, error } = useAuth();
    ...
    <>
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmit}>
                  {/* This error message is for the REGISTRATION form */}
                  {error && !showVerificationPopup && (
                    <p className="text-center text-md text-red-600">{error}</p>
                  )}
                  <div className="grid gap-6">
                    {/* ... (your inputs for fullName, email, password) ... */}
                    <div className="grid gap-6">
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          ...
          {/* Wrap in a form to handle submit */}
          <form onSubmit={handleVerify}>
            <div className="grid gap-4 py-4">
              ...
              {/* ✅ ADDED ERROR MESSAGE INSIDE DIALOG */}
              {/* This error is for the VERIFICATION step */}
              {error && showVerificationPopup && (
                <p className="text-center text-md text-red-600">{error}</p>
              )}
            </div>
